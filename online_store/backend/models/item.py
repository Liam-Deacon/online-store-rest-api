...
class ItemModel(db.Model):
    ...
    brand = db.Column(db.Text)  # TODO: add brands table & change to ForeignKey
    price = db.Column(db.Float, nullable=True)
    currency = db.Column(db.Text)  # TODO: change to foreign key for currencies
